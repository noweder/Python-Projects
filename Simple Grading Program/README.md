...
This program converts their scores to grades. By the end of this program, you should have a new dictionary called `student_grades` that should contain student **names** for **keys** and their **grades** for **values**.
